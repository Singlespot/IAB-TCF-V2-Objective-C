...
+(NSString*)safeBase64ConsentString:(NSString*)consentString {
    NSString *safeString = [SPTIabTCFUtils replaceSafeCharacters:consentString];
    NSString *base64String = [SPTIabTCFUtils addPaddingIfNeeded:safeString];
    return base64String;
}
