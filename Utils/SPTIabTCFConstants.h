...
static int PUBLISHER_PURPOSES_LEGIT_INTEREST_BIT_OFFSET = 29;
static int PUBLISHER_PURPOSES_LEGIT_INTEREST_BIT_LENGTH = 24;

static int PUBLISHER_NUM_CUSTOM_PURPOSES_BIT_OFFSET = 53;
static int PUBLISHER_NUM_CUSTOM_PURPOSES_BIT_LENGTH = 6;

static int PUBLISHER_CUSTOM_PURPOSES_LEGIT_INTEREST_BIT_OFFSET = 59;
static int PUBLISHER_CUSTOM_PURPOSES_LEGIT_INTEREST_BIT_LENGTH = 24;

static int PUBLISHER_CUSTOM_PURPOSES_CONSENT_BIT_OFFSET = 83;
static int PUBLISHER_CUSTOM_PURPOSES_CONSENT_BIT_LENGTH = 24;
